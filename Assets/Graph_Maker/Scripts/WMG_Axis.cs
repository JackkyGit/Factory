...
public class WMG_Axis : WMG_GUI_Functions {
	...
	[SerializeField] List<string> _axisLabels;
	...
	//-jzq
	public Color AxisOverallColor
	{
		get { return _AxisOverallColor; }
		set
		{
			if (_AxisOverallColor != value)
			{
				_AxisOverallColor = value;
				graphC.Changed();
			}
		}
	}
	...
	[SerializeField] float _AxisMinValue;
	[SerializeField] float _AxisMaxValue;
	[SerializeField] int _AxisNumTicks;
	[SerializeField] bool _MinAutoGrow;
	[SerializeField] bool _MaxAutoGrow;
	[SerializeField] bool _MinAutoShrink;
	[SerializeField] bool _MaxAutoShrink;
	[SerializeField] float _AxisLinePadding;
	[SerializeField] bool _AxisUseNonTickPercent;
	[SerializeField] float _AxisNonTickPercent;
	[SerializeField] bool _HideAxisArrowTopRight;
	[SerializeField] bool _HideAxisArrowBotLeft;
	[SerializeField] bool _AxisArrowTopRight;
	[SerializeField] bool _AxisArrowBotLeft;
	[SerializeField] bool _AxisTicksRightAbove;
	[SerializeField] int _AxisTick;
	[SerializeField] bool _hideTick;
	[SerializeField] labelTypes _LabelType;
	[SerializeField] int _AxisLabelSkipStart;
	[SerializeField] int _AxisLabelSkipInterval;
	[SerializeField] float _AxisLabelRotation;
	[SerializeField] bool _SetLabelsUsingMaxMin;
	[SerializeField] int _AxisLabelSize;
	[SerializeField] Color _AxisLabelColor = Color.white;
	//-jzq
	[SerializeField] Color _AxisOverallColor = Color.white;
	[SerializeField] FontStyle _AxisLabelFontStyle = FontStyle.Normal;
	[SerializeField] Font _AxisLabelFont; 
	[SerializeField] int _numDecimalsAxisLabels;
	[SerializeField] bool _hideLabels;
	[SerializeField] float _AxisLabelSpaceOffset;
	[SerializeField] float _autoFitRotation;
	[SerializeField] float _autoFitMaxBorder;
	[SerializeField] float _AxisLabelSpacing;
	[SerializeField] float _AxisLabelDistBetween;
	[SerializeField] bool _hideGrid;
	[SerializeField] bool _hideTicks;
	[SerializeField] string _AxisTitleString;
	[SerializeField] Vector2 _AxisTitleOffset;
	[SerializeField] int _AxisTitleFontSize;
	...
	// Private variables
	float GridLineLength;
	float AxisLinePaddingTot;
	float AxisPercentagePosition;
	
	// Original property values for use with dynamic resizing
	public int origAxisLabelSize { get; set; }
	public float origAxisLabelSpaceOffset { get; set; }
	public int origAxisTitleFontSize { get; set; }
	public float origAxisLinePadding { get; set; }
	public Vector2 origAxisArrowSize { get; set; }
	...
	WMG_Change_Obj seriesC = new WMG_Change_Obj();
	...
	void axisLabelsChanged(bool editorChange, bool countChanged, bool oneValChanged, int index) {
	...
	public void UpdateAxesGridsAndTicks() {
		...
		if (!hideTicks) {
			...
			foreach (WMG_Node node in GetAxisTickNodes()) {
				...
				//-jzq
				changeSpriteColor(node.objectToScale , AxisOverallColor);
			}
		}
		...
		//-jzq
		changeSpriteColor(AxisArrowUR , AxisOverallColor);
		changeSpriteColor(AxisArrowDL , AxisOverallColor);
		//jzq - axis line change color ....
		changeSpriteColor(AxisLine , AxisOverallColor);
	}
