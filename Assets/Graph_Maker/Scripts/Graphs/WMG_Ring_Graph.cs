...
public class WMG_Ring_Graph : WMG_Graph_Manager {
	...
	[SerializeField] List<Color> _bandColors;
	...
	[SerializeField] List<string> _labels;
	public WMG_List<string> labels = new WMG_List<string>();
	[SerializeField] List<string> _ringIDs;
	public WMG_List<string> ringIDs = new WMG_List<string>();
	[SerializeField] List<bool> _hideRings;
	...
	[SerializeField] bool _bandMode;
	[SerializeField] float _innerRadiusPercentage;
	[SerializeField] float _degrees;
	[SerializeField] float _minValue;
	[SerializeField] float _maxValue;
	[SerializeField] Color _bandColor;
	[SerializeField] bool _autoUpdateBandAlpha;
	[SerializeField] Color _ringColor;
	[SerializeField] float _ringWidth;
	[SerializeField] float _ringPointWidthFactor;
	[SerializeField] float _bandPadding;
	[SerializeField] float _labelLinePadding;
	[SerializeField] Vector2 _leftRightPadding;
	[SerializeField] Vector2 _topBotPadding;
	[SerializeField] bool _antiAliasing;
	[SerializeField] float _antiAliasingStrength;
	...
	float origGraphWidth;
	public float RingWidthFactor { get { return ((1 - innerRadiusPercentage) * outerRadius) / origGraphWidth; } }

	// cache
	float containerWidthCached;
	float containerHeightCached;

	// public getter
	public List<WMG_Ring> rings { get; set; }

	// private
	Sprite extraRingSprite;
	Color[] extraRingColors;
	int ringTexSize;

	List<WMG_Change_Obj> changeObjs = new List<WMG_Change_Obj>();
	WMG_Change_Obj numberRingsC = new WMG_Change_Obj();
	WMG_Change_Obj bandColorC = new WMG_Change_Obj();
	WMG_Change_Obj ringColorC = new WMG_Change_Obj();
	WMG_Change_Obj labelsC = new WMG_Change_Obj();
	WMG_Change_Obj degreesC = new WMG_Change_Obj();
	WMG_Change_Obj aRingValC = new WMG_Change_Obj();
	WMG_Change_Obj radiusC = new WMG_Change_Obj();
	WMG_Change_Obj textureC = new WMG_Change_Obj();
	WMG_Change_Obj hideRingsC = new WMG_Change_Obj();

	List<int> aRingValChangeIndices = new List<int>();
	List<int> beforeValCount = new List<int> ();
	List<int> afterValCount = new List<int> ();
	bool hasInit;
