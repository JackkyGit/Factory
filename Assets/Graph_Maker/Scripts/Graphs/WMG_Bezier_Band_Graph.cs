...
public class WMG_Bezier_Band_Graph : WMG_Graph_Manager {
	...
	[SerializeField] List<Color> _fillColors;
	...
	[SerializeField] Color _bandLineColor;
	[SerializeField] float _startHeightPercent;
	[SerializeField] int _bandSpacing;
	[SerializeField] int _bandLineWidth;
	[SerializeField] Vector2 _cubicBezierP1;
	[SerializeField] Vector2 _cubicBezierP2;
	[SerializeField] int _numDecimals;
	[SerializeField] int _fontSize;

	// public getter
	public List<WMG_Bezier_Band> bands { get; set; }
	public float TotalVal { get; set; }

	List<WMG_Change_Obj> changeObjs = new List<WMG_Change_Obj>();
	WMG_Change_Obj allC = new WMG_Change_Obj();
	WMG_Change_Obj cubicBezierC = new WMG_Change_Obj();
	WMG_Change_Obj labelsC = new WMG_Change_Obj();
	WMG_Change_Obj colorsC = new WMG_Change_Obj();
	WMG_Change_Obj fontC = new WMG_Change_Obj();
