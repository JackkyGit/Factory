...
public class WMG_Radar_Graph : WMG_Axis_Graph {
	...
	[SerializeField] List<Color> _dataSeriesColors;
	public WMG_List<Color> dataSeriesColors = new WMG_List<Color>();
	[SerializeField] List<string> _labelStrings;
	...
	[SerializeField] int _numPoints;
	[SerializeField] Vector2 _offset;
	[SerializeField] float _degreeOffset;
	[SerializeField] float _radarMinVal;
	[SerializeField] float _radarMaxVal;
	[SerializeField] int _numGrids;
	[SerializeField] float _gridLineWidth;
	[SerializeField] Color _gridColor;
	[SerializeField] int _numDataSeries;
	[SerializeField] float _dataSeriesLineWidth;
	[SerializeField] Color _labelsColor;
	[SerializeField] float _labelsOffset;
	...
	WMG_Change_Obj radarGraphC = new WMG_Change_Obj();
	WMG_Change_Obj gridsC = new WMG_Change_Obj();
	WMG_Change_Obj labelsC = new WMG_Change_Obj();
	WMG_Change_Obj dataSeriesC = new WMG_Change_Obj();

	bool hasInit2; // same field serialized in base class error ?
