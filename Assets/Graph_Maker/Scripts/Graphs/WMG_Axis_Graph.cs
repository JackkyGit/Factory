...
public class WMG_Axis_Graph : WMG_Graph_Manager {
	...
	[SerializeField] List<string> _groups;
	...
	[SerializeField] graphTypes _graphType;
	[SerializeField] orientationTypes _orientationType;
	[SerializeField] axesTypes _axesType;
	[SerializeField] bool _resizeEnabled;
	[WMG_EnumFlagAttribute] [SerializeField] ResizeProperties _resizeProperties;
	[SerializeField] bool _useGroups;
	[SerializeField] Vector2 _paddingLeftRight;
	[SerializeField] Vector2 _paddingTopBottom;
	[SerializeField] Vector2 _theOrigin;
	[SerializeField] float _barWidth;
	[SerializeField] float _barAxisValue;
	[SerializeField] bool _autoUpdateOrigin;
	[SerializeField] bool _autoUpdateBarWidth;
	[SerializeField] float _autoUpdateBarWidthSpacing;
	[SerializeField] bool _autoUpdateSeriesAxisSpacing;
	[SerializeField] bool _autoUpdateBarAxisValue;
	[SerializeField] int _axisWidth;
	[SerializeField] float _autoShrinkAtPercent;
	[SerializeField] float _autoGrowAndShrinkByPercent;
	[SerializeField] bool _tooltipEnabled;
	[SerializeField] bool _autoAnimationsEnabled;
	[SerializeField] bool _autoFitLabels;
	[SerializeField] float _autoFitPadding;
	[SerializeField] Vector2 _tickSize;
	[SerializeField] string _graphTitleString;
	[SerializeField] Vector2 _graphTitleOffset;
	...
	// Private variables
	List<float> totalPointValues = new List<float>();
	int maxSeriesPointCount;
	int maxSeriesBarCount;
	...
	float origBarWidth;
	float origAxisWidth;
	float origAutoFitPadding;
	Vector2 origTickSize;
	Vector2 origPaddingLeftRight;
	Vector2 origPaddingTopBottom;

	// Cache
	float cachedContainerWidth;
	float cachedContainerHeight;

	// Other variables
	public WMG_Graph_Tooltip theTooltip;
	WMG_Graph_Auto_Anim autoAnim;
	...
	WMG_Change_Obj tooltipEnabledC = new WMG_Change_Obj();
	WMG_Change_Obj autoAnimEnabledC = new WMG_Change_Obj();
	WMG_Change_Obj orientationC = new WMG_Change_Obj();
	WMG_Change_Obj graphTypeC = new WMG_Change_Obj();
