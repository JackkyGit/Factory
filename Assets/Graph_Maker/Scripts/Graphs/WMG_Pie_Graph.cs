...
public class WMG_Pie_Graph : WMG_Graph_Manager {
	...
	[SerializeField] List<float> _sliceValues;
	public WMG_List<float> sliceValues = new WMG_List<float>();
	[SerializeField] List<string> _sliceLabels;
	public WMG_List<string> sliceLabels = new WMG_List<string>();
	[SerializeField] List<Color> _sliceColors;
	...
	[SerializeField] Vector2 _leftRightPadding;
	[SerializeField] Vector2 _topBotPadding;
	[SerializeField] float _bgCircleOffset;
	[SerializeField] bool _autoCenter;
	[SerializeField] float _autoCenterMinPadding;
	[SerializeField] sortMethod _sortBy;
	[SerializeField] bool _swapColorsDuringSort;
	[SerializeField] WMG_Enums.labelTypes _sliceLabelType;
	[SerializeField] float _explodeLength;
	[SerializeField] bool _explodeSymmetrical;
	[SerializeField] bool _useDoughnut;
	[SerializeField] float _doughnutPercentage;
	[SerializeField] bool _limitNumberSlices;
	[SerializeField] bool _includeOthers;
	[SerializeField] int _maxNumberSlices;
	[SerializeField] string _includeOthersLabel;
	[SerializeField] Color _includeOthersColor;
	[SerializeField] float _animationDuration;
	[SerializeField] float _sortAnimationDuration;
	[SerializeField] float _sliceLabelExplodeLength;
	[SerializeField] int _sliceLabelFontSize;
	[SerializeField] int _numberDecimalsInPercents;
	[SerializeField] Color _sliceLabelColor;
	[SerializeField] bool _hideZeroValueLegendEntry;
	[SerializeField] bool _interactivityEnabled;
	...
	float origPieSize;
	float origSliceLabelExplodeLength;
	int origSliceLabelFontSize;
	float origAutoCenterPadding;
	...
	WMG_Change_Obj doughnutC = new WMG_Change_Obj();
	WMG_Change_Obj interactivityC = new WMG_Change_Obj();

	bool hasInit;
	bool setOrig;
	bool doughnutHasInit;
