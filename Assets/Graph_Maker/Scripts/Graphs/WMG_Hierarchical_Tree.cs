...
public class WMG_Hierarchical_Tree : WMG_Graph_Manager {
	...
	float _gridLengthX;
	float _gridLengthY;
	[SerializeField] int _nodeWidthHeight;
	[SerializeField] float _nodeRadius;
	[SerializeField] bool _squareNodes;
	...
	float origWidth;
	float origHeight;
	int origNodeWidthHeight;
	float origNodeRadius;


	List<WMG_Change_Obj> changeObjs = new List<WMG_Change_Obj>();
	WMG_Change_Obj treeC = new WMG_Change_Obj();
	public WMG_Change_Obj resizeC = new WMG_Change_Obj();

	List<GameObject> treeNodes = new List<GameObject>();
	List<GameObject> treeLinks = new List<GameObject>();
	List<GameObject> treeInvisibleNodes = new List<GameObject>();
