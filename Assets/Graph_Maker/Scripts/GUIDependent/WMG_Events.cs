...
public class WMG_Events : WMG_GUI_Functions {
	...
	void AddEventTrigger(UnityAction<GameObject> action, EventTriggerType triggerType, GameObject go)
	{
	...
	void AddEventTrigger(UnityAction<GameObject, bool> action, EventTriggerType triggerType, GameObject go, bool state)
	{
		EventTrigger eventTrigger = go.GetComponent<EventTrigger>();
		if (eventTrigger == null) {
			eventTrigger = go.AddComponent<EventTrigger>();
	...
	void WMG_Click_2(GameObject go) {
		if (WMG_Click != null) {
	...
	void WMG_Link_Click_2(GameObject go) {
	...
	void WMG_Click_Leg_2(GameObject go) {
	...
	void WMG_Link_Click_Leg_2(GameObject go) {
	...
	void WMG_Pie_Slice_Click_2(GameObject go) {
	...
	void WMG_MouseEnter_2(GameObject go, bool state) {
	...
	void WMG_Link_MouseEnter_2(GameObject go, bool state) {
	...
	void WMG_MouseEnter_Leg_2(GameObject go, bool state) {
	...
	void WMG_Link_MouseEnter_Leg_2(GameObject go, bool state) {
	...
	void WMG_Pie_Slice_MouseEnter_2(GameObject go, bool state) {
