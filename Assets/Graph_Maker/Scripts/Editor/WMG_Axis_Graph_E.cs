...
public class WMG_Axis_Graph_E : WMG_E_Util
{
	...
	eTabTypeNullYaxis2 m_tabTypeNullYaxis2 = eTabTypeNullYaxis2.Core;
	...
	void DrawYAxis() {
		...
		//-jzq
		ExposeProperty(yAxisfields["AxisOverallColor"]);
	...
	void DrawYAxis2() {
		...
		//-jzq
		ExposeProperty(yAxis2fields["AxisOverallColor"]);
	...
	void DrawXAxis() {
		...
		//-jzq
		ExposeProperty(xAxisfields["AxisOverallColor"]);
