...
public class WMG_Graph_Auto_Anim : MonoBehaviour {
	...
	void SeriesDataChangedMethod(WMG_Series aSeries) {
	...
	void animateLinkCallback(WMG_Series aSeries, GameObject aGO, bool isLast) {
	...
	void animateLinkCallbackEnd(WMG_Series aSeries, bool isLast) {
