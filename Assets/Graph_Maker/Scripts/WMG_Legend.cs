...
//				setGraphCallback();
	...
	WMG_Axis_Graph axisGraph;

	// Private backing variables
	[SerializeField] bool _hideLegend;
	[SerializeField] legendTypes _legendType;
	[SerializeField] WMG_Enums.labelTypes _labelType;
	[SerializeField] bool _showBackground;
	[SerializeField] bool _oppositeSideLegend;
	[SerializeField] float _offset;
	[SerializeField] float _legendEntryWidth;
	[SerializeField] bool _setWidthFromLabels;
	[SerializeField] float _legendEntryHeight;
	[SerializeField] int _numRowsOrColumns;
	[SerializeField] int _numDecimals;
	[SerializeField] float _legendEntryLinkSpacing;
	[SerializeField] int _legendEntryFontSize;
	[SerializeField] float _legendEntrySpacing;
	[SerializeField] float _pieSwatchSize;
	[SerializeField] float _backgroundPadding;
	[SerializeField] bool _autofitEnabled;
	[SerializeField] Color _labelColor;
	[SerializeField] FontStyle _legendEntryFontStyle = FontStyle.Normal;
	[SerializeField] Font _legendEntryFont; 
	...
	public float origLegendEntryWidth { get; set; }
	public float origLegendEntryHeight { get; set; }
	public float origLegendEntryLinkSpacing { get; set; }
	public int origLegendEntryFontSize { get; set; }
	public float origLegendEntrySpacing { get; set; }
	public float origPieSwatchSize { get; set; }
	public float origOffset { get; set; }
	public float origBackgroundPadding { get; set; }
