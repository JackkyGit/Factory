...
public class WMG_Graph_Manager : WMG_Events, IWMG_Data_Generators, IWMG_Caching_Functions, IWMG_Path_Finding {
	...
	List<GameObject> nodesParent = new List<GameObject>(); // Each gameobject in this list is a WMG Node
	List<GameObject> linksParent = new List<GameObject>(); // Each gameobject in this list is a WMG Link
	
	// Data generation functions
	WMG_Data_Generators data_gen = new WMG_Data_Generators();
	...
	// Caching functions
	WMG_Caching_Functions caching = new WMG_Caching_Functions();
	...
	WMG_Path_Finding path_find = new WMG_Path_Finding();
