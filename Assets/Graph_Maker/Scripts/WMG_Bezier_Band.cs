...
//	public GameObject bandBotLineSpriteGO;
	...
	Sprite bandFillSprite;
	Sprite bandLineSprite;
	Material bandFillMat;
	Material bandLineMat;
//	Sprite bandBotLineSprite;
	Color[] bandFillColors;
	Color[] bandLineColors;
//	Color[] bandBotLineColors;
	int texSize;
